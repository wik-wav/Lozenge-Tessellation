...
tags:
  ...
  - language
  - grammar
title: náxănåsi (Abs NEVER Temporal Connector) - "Under no circumstances".
---
...
2. **[[xă (Particle)|hă]]** (Indeed/Emphasis)
3. **[[nåsi (NEVER Aspectual Marker)|nåsi]]** (Never / Time-Void)])]

- _Logic:_ "Not-Indeed-Never" (Double negative logic usually intensifies in Asaxi: "It is a fact that I never...").

### Syntax

Placed at the **end** of the sentence.

- _Structure:_ `[Action] náxănåsi.`
...
- **onånáxănåsi**: "Forever never" / "Never in eternity".
    ...
    - _Etymology:_ ****[[onå (FOREVER Aspectual Marker)|onå]] (Forever) + **náxănåsi**.
...
- [[nåsi (NEVER Aspectual Marker)|nåsi]] (Never - Standard).

### Antonyms

- **[[nanå (OFTEN Aspectual Marker)|nanå]]** (Often).
- **[[onå (FOREVER Aspectual Marker)|onå]]** (Always/Forever).