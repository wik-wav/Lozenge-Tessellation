...
### Structural Sets - Elements of Asaxi

[[00_Structural Sets in Asaxi|The Structure Sets Meta Document]]

### Lexicon - The Dictionary of Asaxi

[[01_Asaxi Nouns (List)|Nouns (List)]]
[[03_Asaxi Adjectives (List)|Adjectives (List)]]
[[02_Asaxi Verbs_ů (List)|Verbs (List)]]
[[01_Function words in Asaxi (list)|Asaxi Function Words (list)]]
...
Inhabitants of the [[The Lozenge Tessellation|Lozenge T.]] live out their lives as anyone else, not aware of the (un)reality of their existence. As such, they are very curious about their environment. The language reflects this natural curiosity. Many constructions relate natural phenomena to everyday ideas, a lot are about physicality—for example, the senses are ingrained into the Verbal Derivation system.
...
Asaxi strictly follows a **Modifier-Head** structure. Information is built by placing descriptive elements _before_ (to the left of) the core word they modify.
...
**Exception (The Particle Tail):** Discourse Markers, Logical Connectors, and Modal Particles (`kè`, `tte`) are strictly Right-Branching, appearing at the very end to modify the preceding proposition.
...
## 5. Verbal Derivation (The `-ů` System)

Asaxi possesses a small closed class of **Root Verbs** (primitive actions like _go, stop, see_). The vast majority of verbs are constructed via **Universal Verbalization**.

- **Mechanism:** A Noun or Concept is converted into a Verb using the suffix **-ů**.
- **Mode Infixes:** A morphological bridge acts as an infix to define the _logic_ of the conversion.
    - _Performance (`-n-`):_ To use/function as X.
    - _Semblance (`-w-`):_ To act like X.
    - _Interaction (`-x-`):_ To apply X to an object.
    - _Sensory (`-j-`, `-s-`, etc.):_ To look/sound/smell/feel-to-the-touch like X.

## 6. The Split Copula (Identity vs. Performance)

The concept of "To Be" is divided into two distinct grammatical functions:

1. **Static Validity (`xiŕa`):** Defines essential identity, origin, or unchangeable facts. (X _is_ Y).
	- **Active Performance (`ů` / `bů`):** Defines temporary states, roles, or behaviors. (X _is acting as_ Y).
