...
- **Tense:** Tense prefixes attach to the `xi` root, wrapping it inside the validity marker.
    - _Past:_ **zèxiŕa** (Existed / Was).
    - _Future:_ **paxiŕa** (Will exist / Will be).

- **Proximal Location:** Deictic prefixes attach to `xi` to define location as a state.
    - _Example:_ **oxiŕa** (Is here).
...
- **[[02_Particles in Asaxi|High Binding Particle]]**:
...
Word derived from Japanese いる (_iru_) - to be, exist.

### See Also

- [[06_To Be in Asaxi_Active Verb and Stative Particle]]
- [[21_Existential Logic & The Validity System]]