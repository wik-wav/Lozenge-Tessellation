...
Stdlib only. Reuses the Asaxi g2p from vocab_forge/synth_diphone.py.
...
sys.path.insert(0, str(Path(__file__).resolve().parent.parent / "vocab_forge"))
try:
    from synth_diphone import g2p_asaxi
except Exception as e:                                    # pragma: no cover
    sys.exit(f"cannot import g2p_asaxi from vocab_forge/synth_diphone.py: {e}")
