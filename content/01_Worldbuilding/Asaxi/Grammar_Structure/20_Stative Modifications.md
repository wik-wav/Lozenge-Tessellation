---
title: 20_Stative Modifications
tags:
  - Asaxi
  - language
  - grammar
...
- **Nuance:**
    - **Stative (`-ŕa`):** The subject _is_ (occupies in a way that is unchangeable). (Existential/Passive).
    - **Active (`-nů`):** The subject _occupies_, _inhabits_, _is in_ the space. (Transitive/Active).
