...
## Grammatical Concept: The Abstract Sequence
...
- **Etymology:** Derived from **[[bi (noun)|bi]]** (Line/Level).
...
- **Etymology:** Derived from **[[kamm (noun)|kamm]]** (Building/Structure).
...
- **tă** (Plus / Add).
- **më** (Minus / Subtract).
- **naŕo** (Multiplication). _Etym: `na` (Stacking) + `ŕo` (Place)._
- **pùŕo** (Division). _Etym: `pù` (Below) + `ŕo` (Place)._
- **tambi** (Equals). _Etym: `tam` (Two) + `bi` (Line)._
