---
title: 55_Subjective Tense & Register
tags:
  - Asaxi
  - language
  - grammar
...
## Grammatical Concept: The Internal Voice
...
Used to describe feelings, sensations, or internal states occurring _right now_. It frames the action as an **Immersion**.
...
- **Phonotactics (No Bridge):** Because `sỏ` ends in a diphthong (/ou̯/), it **does not** require a bridge consonant when attaching to vowels. The off-glide acts as the buffer.
    - _Example:_ `sỏ` + `ijo` → **sỏijo** ("Reminisced seeing").
