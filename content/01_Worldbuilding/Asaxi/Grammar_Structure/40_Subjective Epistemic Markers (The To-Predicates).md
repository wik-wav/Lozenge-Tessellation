---
title: 40_Subjective Epistemic Markers (The To-Predicates)
tags:
  - Asaxi
  - language
  - grammar
...
## Grammatical Concept: The Clausal Subject
...
- **Components:** `to` + `xăhè`.
- **Meaning:** "I am convinced that...", "Undoubtedly..."

**B. Doubt: `tohùfwo` (I doubt that...)**

- **Components:** `to` + `hùfwo`.
- **Meaning:** "I doubt...", "It is doubtful..."

**C. Impression: `toůchů` (It feels like...)**

- **Components:** `to` + `ůchů`.
- **Meaning:** "It feels like...", "It seems..."
...
- **Internal Past:** **ăsỏůchů** ("It _felt_ like..." - Reliving the sensation).
...
- **Standard Order:** `Subject` + `Tense` + `Root`
    - _Ex:_ **tozèůchů** / **ăsỏůchů**

- **Inverted Order:** `Tense` + `Subject` + `Root`
    - _Ex:_ **zètoůchů** / **sỏăůchů**
