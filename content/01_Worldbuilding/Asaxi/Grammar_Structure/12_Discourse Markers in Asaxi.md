---
title: 12_Discourse Markers in Asaxi
tags:
  - Asaxi
  - language
  - grammar
...
## Grammatical Concept: Pragmatic Particles
...
While normally used as Clause Connectors (appearing _between_ clauses), the logical particles **And** (`ŕa`) and **But** (`dzè`) can appear at the start of a sentence.
