---
title: 01_Function words in Asaxi (list)
tags:
  - Asaxi
  - language
  - list
  ...
  - grammar
---
This is a list of all function words in Asaxi, with their closest English translations.
...
- _Note:_ The **Cessative Aspect** is handled by the root verb **[[tomo' (verb)|tomo']]** (Stop), which appears _after_ the main verb.

### Verbal Derivation (Morphological Infixes)
...
_Prefixes and particles used to modify intensity or compare nouns._
...
- **[[kozèvkozè (Idiom)]]** - once upon a time / long, long ago
...
_Markers for counting, frequency, and mathematical operations._
