---
title: 56_Relative Time Specification
tags:
  - Asaxi
  - language
  - grammar
...
Asaxi specifies relative time (how long ago or how far in the future) by treating temporal units as physical distances from the speaker ("Now"). It utilizes the **Spatial Nouns** derived from the proximal/directional roots _hù_ (Behind) and _pa_ (Front).
...
- _Literal:_ "\[Number\] \[Unit\] (is) behind."
- _Meaning:_ "\[Number\] \[Unit\] ago."

**Future (From now):** `[Number] [Unit] pawo`

- _Literal:_ "\[Number\] \[Unit\] (is) in front."
- _Meaning:_ "\[Number\] \[Unit\] from now / in \[Number\] \[Unit\]."
