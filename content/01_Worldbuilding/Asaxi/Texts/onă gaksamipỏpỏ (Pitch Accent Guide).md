...
tags:
  ...
  - prosody
  - reading-guide
generated_by: asaxi_reading_guide.py/1.0
...
- `L%` is a statement fall, `H%` an insistent high ending, and `H-` a continuation.
- Dictionary / phrase accent is source data. Predicted in utterance shows the current model after morphology, phrasing, downstep, deaccenting, and boundary rules.
- Read the Asaxi line naturally. The labels guide relative melody; they are not exact musical notes or stress marks.

This guide contains 244 utterances from `onă gaksamipỏpỏ (Reader's Text).md`.
...
Speech act: `statement` · Source line: 23
...
Speech act: `statement` · Source line: 25
...
Speech act: `statement` · Source line: 27
...
Speech act: `statement` · Source line: 29
...
Speech act: `statement` · Source line: 31
...
Speech act: `statement` · Source line: 33
...
| 11 | ja | ja | `L` | `L` | `atonal` | — |
| 12 | bỏbama | bỏ · ba · ma | `H.L.L` | `H.L.L` | `morphological` | `bỏba` (root) + `-ma` (plural) |
| 13 | ni | ni | `L` | `L` | `atonal` | — |
| 14 | anő | a · nő | `L.L` | `L.L` | `atonal` | — |
| 15 | komonů | ko · mo · nů | `H.L.L` | `H.L.L` | `lexical` | — |
| 16 | zèxogă | zè · xo · gă | `L.L.H` | `L.L.H` | `morphological` | `zè-` (prefix) + `xogă` (root) |
| 17 | ŕa | ŕa | `L` | `L` | `atonal` | — |
| 18 | sè | sè | `L` | `L` | `atonal` | — |
| 19 | txenă | txe · nă | `H.H` | `H.H` | `mixed` | — |
| 20 | shěno | shě · no | `H.H` | `H.H` | `mixed` | — |
| 21 | dănă | dă · nă | `H.L` | `H.L` | `lexical` | — |
...
Speech act: `statement` · Source line: 38
...
Speech act: `statement` · Source line: 40
...
Speech act: `statement` · Source line: 42
...
Speech act: `statement` · Source line: 44
...
| 9 | sè | sè | `L` | `L` | `atonal` | — |
| 10 | xő | xő | `L` | `L` | `atonal` | — |
| 11 | gámŕo | gá · mŕo | `H.L` | `H.L` | `lexical` | — |
| 12 | dăgo | dă · go | `L.L` | `L.L` | `atonal` | — |
| 13 | hùzètákshù | hù · zè · tá · kshù | `L.L.H.L` | `L.L.H.L` | `morphological` | `hù-` (prefix) + `zè-` (prefix) + `tákshù` (root) |
| 14 | izo | i · zo | `L.L` | `L.L` | `atonal` | — |
| 15 | hja | hja | `L` | `L` | `atonal` | — |
| 16 | onă | o · nă | `L.L` | `L.L` | `atonal` | — |
| 17 | jýno | jý · no | `H.H` | `H.H` | `mixed` | — |
...
Speech act: `statement` · Source line: 46
...
| 35 | nánaŕè | ná · na · ŕè | `H.L.L` | `H.L.L` | `lexical` | — |
| 36 | tte | t · te | `L.L` | `L.L` | `atonal` | — |
| 37 | xő | xő | `L` | `L` | `atonal` | — |
...
Speech act: `statement` · Source line: 48
...
Speech act: `statement` · Source line: 50
...
Speech act: `statement` · Source line: 55
...
Speech act: `statement` · Source line: 57
...
| 14 | pỏbiwa | pỏ · bi · wa | `H.L.L` | `H.L.L` | `morphological` | `pỏbi` (root) + `-wa` (plural) |
| 15 | zèdåmë | zè · då · më | `L.H.L` | `L.H.L` | `morphological` | `zè-` (prefix) + `dåmë` (root) |
| 16 | ŕa | ŕa | `L` | `L` | `atonal` | — |
| 17 | dhè | dhè | `L` | `L` | `atonal` | — |
| 18 | sè | sè | `L` | `L` | `atonal` | — |
| 19 | xő | xő | `L` | `L` | `atonal` | — |
| 20 | dëŕă | dë · ŕă | `H.L` | `H.L` | `lexical` | — |
| 21 | těpỏ | tě · pỏ | `L.H` | `L.H` | `lexical` | — |
...
Speech act: `statement` · Source line: 59
...
Speech act: `statement` · Source line: 61
...
<span class="asaxi-text">„xăcènă kjo xiŕa?”</span>

Predicted sentence reading: `L.L.L.H.L.L↗`

Boundary tone: `LH%` (appeal contour with a final rise)

Speech act: `question` · Source line: 66

| # | Asaxi word | Morae | Dictionary / phrase accent | Predicted in utterance | Class | Morpheme analysis |
|---:|---|---|---|---|---|---|
| 1 | xăcènă | xă · cè · nă | `H.L.L` | `L.L.L` | `lexical` | — |
| 2 | kjo | kjo | `H` | `H` | `dominant` | — |
...
Speech act: `statement` · Source line: 66

| # | Asaxi word | Morae | Dictionary / phrase accent | Predicted in utterance | Class | Morpheme analysis |
|---:|---|---|---|---|---|---|
| 1 | tte | t · te | `L.L` | `L.H` | `atonal` | — |
| 2 | gănå | gă · nå | `L.L` | `L.L` | `atonal` | — |
...
<span class="asaxi-text">„vano zizisů nona ja anő pădåmë kmano ma tte jo ijù kè?”</span>

Predicted sentence reading: `L.L.H.L.L.H.L.L.L.L.L.H.L.H.L.H.L.L.H.H.L.L↗`

Boundary tone: `LH%` (appeal contour with a final rise)

Speech act: `question` · Source line: 68
...
| 6 | pădåmë | pă · då · më | `L.H.L` | `L.H.L` | `morphological` | `pă-` (prefix) + `dåmë` (root) |
| 7 | kmano | kma · no | `H.L` | `H.L` | `lexical` | — |
| 8 | ma | ma | `H` | `H` | `lexical` | — |
| 9 | tte | t · te | `L.L` | `L.L` | `atonal` | — |
| 10 | jo | jo | `H` | `H` | `lexical` | — |
| 11 | ijù | i · jù | `H.L` | `H.L` | `lexical` | — |
| 12 | kè | kè | `L` | `L` | `atonal` | — |
...
Speech act: `statement` · Source line: 70

| # | Asaxi word | Morae | Dictionary / phrase accent | Predicted in utterance | Class | Morpheme analysis |
|---:|---|---|---|---|---|---|
| 1 | xăcènă | xă · cè · nă | `H.L.L` | `H.L.L` | `lexical` | — |
| 2 | tte | t · te | `L.L` | `L.L` | `atonal` | — |
| 3 | ksá | ksá | `H` | `H` | `dominant` | — |
| 4 | no | no | `L` | `L` | `atonal` | — |
...
<span class="asaxi-text">„jo onýj ni no xogă nono xiŕa.”</span>

Predicted sentence reading: `H.L.L.L.L.L.H.H.L.L.L`
...
| 3 | ni | ni | `L` | `L` | `atonal` | — |
| 4 | no | no | `L` | `L` | `atonal` | — |
| 5 | xogă | xo · gă | `L.H` | `L.H` | `lexical` | — |
| 6 | nono | no · no | `H.L` | `H.L` | `lexical` | — |
...
| 8 | vå | vå | `L` | `L` | `atonal` | — |
| 9 | igùŕanů | i · gù · ŕa · nů | `H.L.L.L` | `H.L.L.L` | `lexical` | — |
| 10 | då | då | `L` | `L` | `atonal` | — |
...
<span class="asaxi-text">„jo aixa kè?”</span>

Predicted sentence reading: `L.H.L.L.L↗`

Boundary tone: `LH%` (appeal contour with a final rise)

Speech act: `question` · Source line: 72

| # | Asaxi word | Morae | Dictionary / phrase accent | Predicted in utterance | Class | Morpheme analysis |
|---:|---|---|---|---|---|---|
| 1 | jo | jo | `H` | `L` | `lexical` | — |
| 2 | aixa | a · i · xa | `H.L.L` | `H.L.L` | `lexical` | — |
| 3 | kè | kè | `L` | `L` | `atonal` | — |
...
<span class="asaxi-text">tte pỏpỏ zèkëjù.</span>

Predicted sentence reading: `L.H.L.L.L.H.L`

Boundary tone: `L%` (closed assertion with a final fall)

Speech act: `statement` · Source line: 72

| # | Asaxi word | Morae | Dictionary / phrase accent | Predicted in utterance | Class | Morpheme analysis |
|---:|---|---|---|---|---|---|
| 1 | tte | t · te | `L.L` | `L.H` | `atonal` | — |
| 2 | pỏpỏ | pỏ · pỏ | `H.L` | `L.L` | `lexical` | — |
| 3 | zèkëjù | zè · kë · jù | `L.H.L` | `L.H.L` | `morphological` | `zè-` (prefix) + `këjù` (root) |
...
Speech act: `statement` · Source line: 74
...
<span class="asaxi-text">„jo săbam xogă kè — ksá anő ŕoka — si jonojo?”</span>

Predicted sentence reading: `L.H.H.L.H.L.H.L.L.H.L.L.L.L.L↗`

Boundary tone: `LH%` (appeal contour with a final rise)

Speech act: `question` · Source line: 76

| # | Asaxi word | Morae | Dictionary / phrase accent | Predicted in utterance | Class | Morpheme analysis |
|---:|---|---|---|---|---|---|
| 1 | jo | jo | `H` | `L` | `lexical` | — |
| 2 | săbam | să · bam | `H.H` | `H.H` | `morphological` | `să` (root) + `-bam` (suffix) |
| 3 | xogă | xo · gă | `L.H` | `L.H` | `lexical` | — |
| 4 | kè | kè | `L` | `L` | `atonal` | — |
| 5 | ksá | ksá | `H` | `H` | `dominant` | — |
| 6 | anő | a · nő | `L.L` | `L.L` | `atonal` | — |
| 7 | ŕoka | ŕo · ka | `H.L` | `H.L` | `lexical` | — |
| 8 | si | si | `L` | `L` | `atonal` | — |
| 9 | jonojo | jo · no · jo | `L.L.L` | `L.L.L` | `atonal` | — |
...
<span class="asaxi-text">tte xő zèkëjù.</span>

Predicted sentence reading: `L.H.L.L.H.L`

Boundary tone: `L%` (closed assertion with a final fall)

Speech act: `statement` · Source line: 76
...
Speech act: `statement` · Source line: 78
...
| 6 | dzo' | dzo' | `H` | `H` | `lexical` | — |
| 7 | sháma | shá · ma | `H.H` | `H.H` | `morphological` | `shá` (root) + `-ma` (plural) |
| 8 | si | si | `L` | `L` | `atonal` | — |
| 9 | ni | ni | `L` | `L` | `atonal` | — |
...
| 15 | si | si | `L` | `L` | `atonal` | — |
| 16 | ni | ni | `L` | `L` | `atonal` | — |
| 17 | onă | o · nă | `L.L` | `L.L` | `atonal` | — |
| 18 | dhè | dhè | `L` | `L` | `atonal` | — |
| 19 | hjihjină | hji · hji · nă | `H.L.L` | `H.L.L` | `lexical` | — |
| 20 | sùva | sù · va | `H.L` | `H.L` | `lexical` | — |
...
Speech act: `statement` · Source line: 80
...
| 5 | itáka | i · tá · ka | `H.L.L` | `H.L.L` | `lexical` | — |
| 6 | nỏwë | nỏ · wë | `L.L` | `L.L` | `atonal` | — |
...
<span class="asaxi-text">„no xăcèshá xiŕa tte pùŕima?”</span>

Predicted sentence reading: `L.L.L.L.L.L.L.L.L.L.L↗`

Boundary tone: `LH%` (appeal contour with a final rise)

Speech act: `question` · Source line: 82
...
| 2 | xăcèshá | xă · cè · shá | `H.L.L` | `L.L.L` | `lexical` | — |
| 3 | xiŕa | xi · ŕa | `L.L` | `L.L` | `atonal` | — |
| 4 | tte | t · te | `L.L` | `L.L` | `phrase` | — |
| 5 | pùŕima | pù · ŕi · ma | `L.H.L` | `L.L.L` | `phrase` | — |

### Utterance 37

<span class="asaxi-text">tte pỏpỏ zëjù.</span>

Predicted sentence reading: `L.H.L.L.H.L`

Boundary tone: `L%` (closed assertion with a final fall)

Speech act: `statement` · Source line: 82
...
| 2 | wo | wo | `L` | `L` | `atonal` | — |
| 3 | jo | jo | `H` | `H` | `lexical` | — |
| 4 | ijù | i · jù | `H.L` | `H.L` | `lexical` | — |
| 5 | panå | pa · nå | `L.L` | `L.L` | `atonal` | — |
| 6 | tte | t · te | `L.L` | `L.L` | `atonal` | — |
| 7 | xő | xő | `L` | `L` | `atonal` | — |
...
| 14 | xő | xő | `L` | `L` | `atonal` | — |
| 15 | zèŕima | zè · ŕi · ma | `L.H.L` | `L.H.L` | `morphological` | `zè-` (prefix) + `ŕima` (root) |
...
Speech act: `statement` · Source line: 84
...
<span class="asaxi-text">„jo onå måmåŕa.”</span>

Predicted sentence reading: `H.L.L.H.L.L`
...
<span class="asaxi-text">pỏpỏ dănă săfwù zèxopă.</span>

Predicted sentence reading: `H.L.H.L.H.L.L.H.H`

Boundary tone: `L%` (closed assertion with a final fall)

Speech act: `statement` · Source line: 86

| # | Asaxi word | Morae | Dictionary / phrase accent | Predicted in utterance | Class | Morpheme analysis |
|---:|---|---|---|---|---|---|
| 1 | pỏpỏ | pỏ · pỏ | `H.L` | `H.L` | `lexical` | — |
| 2 | dănă | dă · nă | `H.L` | `H.L` | `lexical` | — |
| 3 | săfwù | să · fwù | `H.L` | `H.L` | `lexical` | — |
| 4 | zèxopă | zè · xo · pă | `L.H.H` | `L.H.H` | `morphological` | `zè-` (prefix) + `xopă` (root) |
...
| 5 | txaŕăijo | txa · ŕă · i · jo | `H.L.L.L` | `H.L.L.L` | `lexical` | — |
| 6 | ni | ni | `L` | `L` | `atonal` | — |
| 7 | wo | wo | `L` | `L` | `atonal` | — |
...
| 13 | xő | xő | `L` | `L` | `atonal` | — |
| 14 | zèjå | zè · jå | `L.H` | `L.H` | `morphological` | `zè-` (prefix) + `jå` (root) |
| 15 | dăxă | dă · xă | `L.L` | `L.L` | `atonal` | — |
...
<span class="asaxi-text">ponă dhè nana zèvonů shá zèxiŕa, ko hjávakam zèxùja.</span>

Predicted sentence reading: `H.L.L.H.L.H.L.L.H.L.H.H.L.H.L.L.L.H.L`

Boundary tone: `L%` (closed assertion with a final fall)

Speech act: `statement` · Source line: 91

| # | Asaxi word | Morae | Dictionary / phrase accent | Predicted in utterance | Class | Morpheme analysis |
|---:|---|---|---|---|---|---|
| 1 | ponă | po · nă | `L.L` | `H.L` | `atonal` | — |
| 2 | dhè | dhè | `L` | `L` | `atonal` | — |
...
Speech act: `statement` · Source line: 93

| # | Asaxi word | Morae | Dictionary / phrase accent | Predicted in utterance | Class | Morpheme analysis |
|---:|---|---|---|---|---|---|
| 1 | anő | a · nő | `L.L` | `H.L` | `atonal` | — |
| 2 | binů | bi · nů | `H.H` | `H.H` | `mixed` | — |
...
Speech act: `statement` · Source line: 95

| # | Asaxi word | Morae | Dictionary / phrase accent | Predicted in utterance | Class | Morpheme analysis |
|---:|---|---|---|---|---|---|
| 1 | gănå | gă · nå | `L.L` | `H.L` | `atonal` | — |
| 2 | xipùŕo | xi · pù · ŕo | `H.L.L` | `H.L.L` | `lexical` | — |
| 3 | onă | o · nă | `L.L` | `L.L` | `atonal` | — |
| 4 | bỏhjá | bỏ · hjá | `H.L` | `H.L` | `lexical` | — |
| 5 | ni | ni | `L` | `L` | `atonal` | — |
...
| 28 | vå | vå | `L` | `L` | `atonal` | — |
| 29 | ko | ko | `L` | `L` | `atonal` | — |
| 30 | săbam | să · bam | `H.H` | `H.H` | `morphological` | `să` (root) + `-bam` (suffix) |
...
<span class="asaxi-text">„o,” tte ko zëjù, „sè no txănýj pỏpỏhjá tapùhè!”</span>

Predicted sentence reading: `H.L.L.L.H.L.L.L.H.H.H.L.L.H.L.L↗`

Boundary tone: `LH%` (appeal contour with a final rise)

Speech act: `directive` · Source line: 97
...
<span class="asaxi-text">„zá no nùnù då xő gavină paxiŕa!”</span>

Predicted sentence reading: `L.L.H.L.L.L.H.L.L.L.H.H↗`
...
<span class="asaxi-text">ŕa ko pỏpỏ bă să mimi zèpăkŕaga, ŕa xő ni sè onă bỏhjá tëbiwa zètopù.</span>

Predicted sentence reading: `H.L.H.L.L.H.H.L.L.L.H.L.L.L.L.L.L.L.H.L.H.L.L.L.H.L`

Boundary tone: `L%` (closed assertion with a final fall)

Speech act: `statement` · Source line: 97
...
| 4 | bă | bă | `L` | `L` | `atonal` | — |
| 5 | să | să | `H` | `H` | `lexical` | — |
| 6 | mimi | mi · mi | `H.L` | `H.L` | `lexical` | — |
| 7 | zèpăkŕaga | zè · pă · kŕa · ga | `L.L.H.L` | `L.L.H.L` | `morphological` | `zè-` (prefix) + `pă-` (prefix) + `kŕaga` (root) |
| 8 | ŕa | ŕa | `L` | `L` | `atonal` | — |
| 9 | xő | xő | `L` | `L` | `atonal` | — |
| 10 | ni | ni | `L` | `L` | `atonal` | — |
| 11 | sè | sè | `L` | `L` | `atonal` | — |
...
| 14 | tëbiwa | të · bi · wa | `H.L.L` | `H.L.L` | `morphological` | `tëbi` (root) + `-wa` (plural) |
| 15 | zètopù | zè · to · pù | `L.H.L` | `L.H.L` | `morphological` | `zè-` (prefix) + `topù` (root) |
...
Speech act: `statement` · Source line: 102
...
Speech act: `statement` · Source line: 104
...
Speech act: `statement` · Source line: 106
...
Speech act: `statement` · Source line: 108
...
| 8 | zèma | zè · ma | `L.H` | `L.H` | `morphological` | `zè-` (prefix) + `ma` (root) |
| 9 | vå | vå | `L` | `L` | `atonal` | — |
| 10 | nana | na · na | `H.L` | `H.L` | `lexical` | — |
| 11 | ni | ni | `L` | `L` | `atonal` | — |
| 12 | sè | sè | `L` | `L` | `atonal` | — |
| 13 | ko | ko | `L` | `L` | `atonal` | — |
| 14 | chỏno | chỏ · no | `H.H` | `H.H` | `mixed` | — |
| 15 | hùzèxoxo | hù · zè · xo · xo | `L.L.H.L` | `L.L.H.L` | `morphological` | `hù-` (prefix) + `zè-` (prefix) + `xoxo` (root) |
| 16 | ŕa | ŕa | `L` | `L` | `atonal` | — |
| 17 | maopjo | ma · o · pjo | `H.L.L` | `H.L.L` | `lexical` | — |
| 18 | na | na | `L` | `L` | `atonal` | — |
| 19 | sè | sè | `L` | `L` | `atonal` | — |
...
Speech act: `statement` · Source line: 110
...
Speech act: `statement` · Source line: 112
...
| 25 | pỏbi | pỏ · bi | `H.L` | `H.L` | `lexical` | — |
| 26 | alănů | a · lă · nů | `H.L.L` | `H.L.L` | `lexical` | — |
| 27 | ŕa | ŕa | `L` | `L` | `atonal` | — |
| 28 | gapiva | ga · pi · va | `L.H.L` | `L.H.L` | `lexical` | — |
| 29 | săsă | să · să | `L.L` | `L.L` | `atonal` | — |
| 30 | izo | i · zo | `L.L` | `L.L` | `atonal` | — |
| 31 | sè | sè | `L` | `L` | `atonal` | — |
| 32 | xő | xő | `L` | `L` | `atonal` | — |
| 33 | fù | fù | `H` | `H` | `lexical` | — |
| 34 | ksi | ksi | `L` | `L` | `atonal` | — |
| 35 | onă | o · nă | `L.L` | `L.L` | `atonal` | — |
| 36 | bỏhjá | bỏ · hjá | `H.L` | `H.L` | `lexical` | — |
| 37 | xő | xő | `L` | `L` | `atonal` | — |
...
Speech act: `statement` · Source line: 117

| # | Asaxi word | Morae | Dictionary / phrase accent | Predicted in utterance | Class | Morpheme analysis |
|---:|---|---|---|---|---|---|
| 1 | jëtxă | jë · txă | `H.L` | `H.L` | `lexical` | — |
...
| 12 | onă | o · nă | `L.L` | `L.L` | `atonal` | — |
| 13 | bỏhjá | bỏ · hjá | `H.L` | `H.L` | `lexical` | — |
| 14 | gă | gă | `H` | `H` | `lexical` | — |
| 15 | ni | ni | `L` | `L` | `atonal` | — |
| 16 | xo | xo | `H` | `H` | `lexical` | — |
| 17 | chěxa | chě · xa | `L.L` | `L.L` | `atonal` | — |
...
Speech act: `statement` · Source line: 119

| # | Asaxi word | Morae | Dictionary / phrase accent | Predicted in utterance | Class | Morpheme analysis |
|---:|---|---|---|---|---|---|
| 1 | ŕa | ŕa | `L` | `H` | `atonal` | — |
| 2 | săbam | să · bam | `H.H` | `L.H` | `morphological` | `să` (root) + `-bam` (suffix) |
| 3 | vå | vå | `L` | `L` | `atonal` | — |
| 4 | dhè | dhè | `L` | `L` | `atonal` | — |
| 5 | onă | o · nă | `L.L` | `L.L` | `atonal` | — |
...
Speech act: `statement` · Source line: 121
...
<span class="asaxi-text">„no sè no txănýj pỏpỏhjá ma xăhè!”</span>

Predicted sentence reading: `L.L.L.H.H.H.L.L.H.H.L↗`

Boundary tone: `LH%` (appeal contour with a final rise)

Speech act: `directive` · Source line: 123
...
<span class="asaxi-text">tte ko zëjù.</span>

Predicted sentence reading: `L.H.L.H.L`

Boundary tone: `L%` (closed assertion with a final fall)

Speech act: `statement` · Source line: 123
...
<span class="asaxi-text">„dhè igùŕano să — onýj dănă jýno săsă, iŕè!”</span>

Predicted sentence reading: `L.H.L.L.L.H.L.L.H.L.H.H.L.L.L.L↗`
...
| 2 | igùŕano | i · gù · ŕa · no | `H.L.L.L` | `H.L.L.L` | `lexical` | — |
| 3 | să | să | `H` | `H` | `lexical` | — |
| 4 | onýj | o · nýj | `L.L` | `L.L` | `atonal` | — |
| 5 | dănă | dă · nă | `H.L` | `H.L` | `lexical` | — |
| 6 | jýno | jý · no | `H.H` | `H.H` | `mixed` | — |
| 7 | săsă | să · să | `L.L` | `L.L` | `atonal` | — |
| 8 | iŕè | i · ŕè | `L.L` | `L.L` | `atonal` | — |
...
Speech act: `statement` · Source line: 125
...
Speech act: `directive` · Source line: 127
...
| 4 | wo | wo | `L` | `L` | `atonal` | — |
| 5 | pỏpỏhjá | pỏ · pỏ · hjá | `H.L.L` | `H.L.L` | `lexical` | — |
| 6 | daohè | da · o · hè | `H.L.L` | `H.L.L` | `morphological` | `dao` (root) + `-hè` (suffix) |

### Utterance 72

<span class="asaxi-text">tte xő zëjù.</span>

Predicted sentence reading: `L.H.L.H.L`

Boundary tone: `L%` (closed assertion with a final fall)

Speech act: `statement` · Source line: 127
...
<span class="asaxi-text">„no no ijù náxăhè.”</span>

Predicted sentence reading: `H.L.H.L.H.H.L`
...
| 1 | no | no | `L` | `H` | `atonal` | — |
| 2 | no | no | `L` | `L` | `atonal` | — |
| 3 | ijù | i · jù | `H.L` | `H.L` | `lexical` | — |
| 4 | náxăhè | ná · xă · hè | `H.H.L` | `H.H.L` | `mixed` | — |

### Utterance 74

<span class="asaxi-text">„xő igùŕano nèŕa.”</span>

Predicted sentence reading: `H.L.L.L.L.L.L`
...
|---:|---|---|---|---|---|---|
| 1 | xő | xő | `L` | `H` | `atonal` | — |
| 2 | igùŕano | i · gù · ŕa · no | `H.L.L.L` | `L.L.L.L` | `lexical` | — |
| 3 | nèŕa | nè · ŕa | `L.L` | `L.L` | `atonal` | — |

### Utterance 75

<span class="asaxi-text">„xő xăcèshá xiŕa!”</span>

Predicted sentence reading: `L.H.L.L.L.L↗`
...
|---:|---|---|---|---|---|---|
| 1 | xő | xő | `L` | `L` | `atonal` | — |
| 2 | xăcèshá | xă · cè · shá | `H.L.L` | `H.L.L` | `lexical` | — |
| 3 | xiŕa | xi · ŕa | `L.L` | `L.L` | `atonal` | — |
...
Speech act: `statement` · Source line: 129

| # | Asaxi word | Morae | Dictionary / phrase accent | Predicted in utterance | Class | Morpheme analysis |
|---:|---|---|---|---|---|---|
| 1 | onă | o · nă | `L.L` | `H.L` | `atonal` | — |
| 2 | hjinýj | hji · nýj | `H.H` | `H.H` | `mixed` | — |
| 3 | pỏpỏ | pỏ · pỏ | `H.L` | `H.L` | `lexical` | — |
| 4 | no | no | `L` | `L` | `atonal` | — |
| 5 | zèmi | zè · mi | `H.L` | `H.L` | `lexical` | — |
| 6 | vå | vå | `L` | `L` | `atonal` | — |
| 7 | ă | ă | `H` | `H` | `dominant` | — |
| 8 | xő | xő | `L` | `L` | `atonal` | — |
...
| 18 | xiŕa | xi · ŕa | `L.L` | `L.L` | `atonal` | — |
| 19 | tte | t · te | `L.L` | `L.L` | `atonal` | — |
| 20 | xő | xő | `L` | `L` | `atonal` | — |
...
<span class="asaxi-text">onă hjávakam-txaŕăijo ni xő hùzèxogă, ŕa xő igùŕano vanå nèŕa.</span>

Predicted sentence reading: `H.L.H.L.L.H.L.L.L.L.L.L.L.L.H.L.L.H.L.L.L.L.L.L.L`
...
| 4 | ni | ni | `L` | `L` | `atonal` | — |
| 5 | xő | xő | `L` | `L` | `atonal` | — |
| 6 | hùzèxogă | hù · zè · xo · gă | `L.L.L.H` | `L.L.L.H` | `morphological` | `hù-` (prefix) + `zè-` (prefix) + `xogă` (root) |
| 7 | ŕa | ŕa | `L` | `L` | `atonal` | — |
| 8 | xő | xő | `L` | `L` | `atonal` | — |
| 9 | igùŕano | i · gù · ŕa · no | `H.L.L.L` | `H.L.L.L` | `lexical` | — |
| 10 | vanå | va · nå | `L.L` | `L.L` | `atonal` | — |
| 11 | nèŕa | nè · ŕa | `L.L` | `L.L` | `atonal` | — |

### Utterance 78

<span class="asaxi-text">xő xăcèshá zèxiŕa.</span>

Predicted sentence reading: `H.L.L.L.L.H.H`
...
Speech act: `statement` · Source line: 131
...
Speech act: `directive` · Source line: 133
...
| 8 | sè | sè | `L` | `L` | `atonal` | — |
| 9 | hja | hja | `L` | `L` | `atonal` | — |
| 10 | pjo | pjo | `H` | `H` | `lexical` | — |
| 11 | kozè | ko · zè | `L.H` | `L.H` | `lexical` | — |
| 12 | hùzètákshù | hù · zè · tá · kshù | `L.L.H.L` | `L.L.H.L` | `morphological` | `hù-` (prefix) + `zè-` (prefix) + `tákshù` (root) |
| 13 | mëja | më · ja | `H.L` | `H.L` | `morphological` | `mëjo` (root) + `-a` (plural) |
| 14 | sè | sè | `L` | `L` | `atonal` | — |
| 15 | shánă | shá · nă | `H.H` | `H.H` | `mixed` | — |
...
Speech act: `directive` · Source line: 135
...
Speech act: `statement` · Source line: 140
...
| 15 | hù | hù | `L` | `L` | `atonal` | — |
| 16 | chă | chă | `H` | `H` | `lexical` | — |
| 17 | ni | ni | `L` | `L` | `atonal` | — |
| 18 | no | no | `L` | `L` | `atonal` | — |
| 19 | igùŕanů | i · gù · ŕa · nů | `H.L.L.L` | `H.L.L.L` | `lexical` | — |
| 20 | då | då | `L` | `L` | `atonal` | — |
...
| 14 | ni | ni | `L` | `L` | `atonal` | — |
| 15 | gănů | gă · nů | `H.H` | `H.H` | `mixed` | — |
| 16 | panå | pa · nå | `L.L` | `L.L` | `atonal` | — |
| 17 | xő | xő | `L` | `L` | `atonal` | — |
...
Speech act: `statement` · Source line: 142
...
Speech act: `statement` · Source line: 144
...
Speech act: `statement` · Source line: 146
...
| 10 | ni | ni | `L` | `L` | `atonal` | — |
| 11 | xő | xő | `L` | `L` | `atonal` | — |
| 12 | xăobi | xă · o · bi | `H.L.H` | `H.L.H` | `morphological` | `xă-` (prefix) + `obi` (root) |
| 13 | zèŋawa | zè · ŋa · wa | `L.H.L` | `L.H.L` | `morphological` | `zè-` (prefix) + `ŋawa` (root) |
| 14 | sè | sè | `L` | `L` | `atonal` | — |
...
| 27 | ijo | i · jo | `H.L` | `H.L` | `lexical` | — |
| 28 | då | då | `L` | `L` | `atonal` | — |
| 29 | sèwo | sè · wo | `L.L` | `L.L` | `atonal` | — |
| 30 | onă | o · nă | `L.L` | `L.L` | `atonal` | — |
| 31 | chåxa | chå · xa | `H.L` | `H.L` | `lexical` | — |
| 32 | sháma | shá · ma | `H.H` | `H.H` | `morphological` | `shá` (root) + `-ma` (plural) |
...
<span class="asaxi-text">gja săsă jënýj pỏpỏkxe zèxiŕa.</span>

Predicted sentence reading: `H.L.L.H.H.H.L.L.L.H.H`
...
Speech act: `statement` · Source line: 148
...
<span class="asaxi-text">ŕa onå sè gja fùwa zèfŕefŕenů.</span>

Predicted sentence reading: `H.L.L.L.L.H.H.L.H.L.L`
...
<span class="asaxi-text">„no ksè xonaná ŕa zá wa igùŕanůná?”</span>

Predicted sentence reading: `L.H.L.L.L.L.L.L.L.L.L.L.L↗`

Boundary tone: `LH%` (appeal contour with a final rise)

Speech act: `question` · Source line: 150
...
<span class="asaxi-text">tte gőnă izo gja zèkëjù.</span>

Predicted sentence reading: `L.H.L.L.L.L.L.L.H.L`

Boundary tone: `L%` (closed assertion with a final fall)

Speech act: `statement` · Source line: 150
...
Speech act: `statement` · Source line: 152
...
<span class="asaxi-text">„ho!”</span>

Predicted sentence reading: `H↗`

Boundary tone: `LH%` (appeal contour with a final rise)

Speech act: `directive` · Source line: 154
...
Speech act: `statement` · Source line: 154
...
<span class="asaxi-text">ŕa xő ni bawo dănă pỏpù ŕa na sè xő hùwaśbiwa zèchěto'.</span>

Predicted sentence reading: `H.L.L.L.H.H.L.H.L.L.L.L.L.H.L.L.L.L.H.L`
...
| 2 | xő | xő | `L` | `L` | `atonal` | — |
| 3 | ni | ni | `L` | `L` | `atonal` | — |
| 4 | bawo | ba · wo | `L.H` | `L.H` | `lexical` | — |
| 5 | dănă | dă · nă | `H.L` | `H.L` | `lexical` | — |
| 6 | pỏpù | pỏ · pù | `H.L` | `H.L` | `lexical` | — |
| 7 | ŕa | ŕa | `L` | `L` | `atonal` | — |
| 8 | na | na | `L` | `L` | `atonal` | — |
| 9 | sè | sè | `L` | `L` | `atonal` | — |
| 10 | xő | xő | `L` | `L` | `atonal` | — |
...
<span class="asaxi-text">„no ken tte wo cèvaná!”</span>

Predicted sentence reading: `L.L.L.L.L.H.L.H↗`

Boundary tone: `LH%` (appeal contour with a final rise)

Speech act: `directive` · Source line: 156
...
Speech act: `statement` · Source line: 156
...
<span class="asaxi-text">„wo ken!”</span>

Predicted sentence reading: `L.L↗`

Boundary tone: `LH%` (appeal contour with a final rise)

Speech act: `directive` · Source line: 158
...
<span class="asaxi-text">tte onă hjinýj pỏpỏ zëjù.</span>

Predicted sentence reading: `L.H.L.L.H.H.H.L.H.L`

Boundary tone: `L%` (closed assertion with a final fall)

Speech act: `statement` · Source line: 158
...
| 6 | xa | xa | `L` | `L` | `atonal` | — |
| 7 | chåxa | chå · xa | `H.L` | `H.L` | `lexical` | — |
| 8 | ken | ken | `L` | `L` | `atonal` | — |
...
| 3 | bỏhjá | bỏ · hjá | `H.L` | `H.L` | `lexical` | — |
| 4 | xő | xő | `L` | `L` | `atonal` | — |
| 5 | txo | txo | `H` | `H` | `lexical` | — |
| 6 | tte | t · te | `L.L` | `L.L` | `atonal` | — |
| 7 | xő | xő | `L` | `L` | `atonal` | — |
| 8 | zèjåka | zè · jå · ka | `L.H.L` | `L.H.L` | `morphological` | `zè-` (prefix) + `jåka` (root) |
...
<span class="asaxi-text">„na sè no hùwaśbiwa pỏpù ken kè?”</span>

Predicted sentence reading: `L.L.L.H.L.L.L.H.L.L.L↗`

Boundary tone: `LH%` (appeal contour with a final rise)

Speech act: `question` · Source line: 160
...
Speech act: `statement` · Source line: 160
...
Speech act: `directive` · Source line: 162
...
<span class="asaxi-text">sè xő hùwo izo să nono săsă kamŕů — ksá anő ihjáka-ỏbỏ.</span>

Predicted sentence reading: `H.L.L.H.L.L.H.H.L.L.L.H.L.H.L.L.H.L.L.H.L`

Boundary tone: `L%` (closed assertion with a final fall)

Speech act: `statement` · Source line: 162

| # | Asaxi word | Morae | Dictionary / phrase accent | Predicted in utterance | Class | Morpheme analysis |
|---:|---|---|---|---|---|---|
| 1 | sè | sè | `L` | `H` | `atonal` | — |
| 2 | xő | xő | `L` | `L` | `atonal` | — |
| 3 | hùwo | hù · wo | `L.H` | `L.H` | `lexical` | — |
| 4 | izo | i · zo | `L.L` | `L.L` | `atonal` | — |
| 5 | să | să | `H` | `H` | `lexical` | — |
| 6 | nono | no · no | `H.L` | `H.L` | `lexical` | — |
| 7 | săsă | să · să | `L.L` | `L.L` | `atonal` | — |
| 8 | kamŕů | ka · mŕů | `H.L` | `H.L` | `lexical` | — |
| 9 | ksá | ksá | `H` | `H` | `dominant` | — |
| 10 | anő | a · nő | `L.L` | `L.L` | `atonal` | — |
| 11 | ihjáka | i · hjá · ka | `H.L.L` | `H.L.L` | `lexical` | — |
| 12 | ỏbỏ | ỏ · bỏ | `H.L` | `H.L` | `lexical` | — |
...
<span class="asaxi-text">„wo nỏwă!”</span>

Predicted sentence reading: `L.L.L↗`

Boundary tone: `LH%` (appeal contour with a final rise)

Speech act: `directive` · Source line: 164

| # | Asaxi word | Morae | Dictionary / phrase accent | Predicted in utterance | Class | Morpheme analysis |
|---:|---|---|---|---|---|---|
| 1 | wo | wo | `L` | `L` | `atonal` | — |
| 2 | nỏwă | nỏ · wă | `L.L` | `L.L` | `atonal` | — |
...
Speech act: `statement` · Source line: 164
...
Speech act: `statement` · Source line: 166
...
<span class="asaxi-text">ŕa onă o-pỏpỏ sè xő nodo zèpăxè ŕa zèmëjonů.</span>

Predicted sentence reading: `H.L.L.H.H.L.L.L.H.L.L.L.H.L.L.H.L.L`
...
<span class="asaxi-text">„xő hùwaśbiwa săsă fůma!”</span>

Predicted sentence reading: `L.H.L.L.L.L.L.H.L↗`

Boundary tone: `LH%` (appeal contour with a final rise)

Speech act: `directive` · Source line: 168
...
Speech act: `statement` · Source line: 168
...
<span class="asaxi-text">„gafůhùwaśbi pỏpỏ — iŕè!”</span>

Predicted sentence reading: `H.L.L.L.L.H.L.L.L↗`
...
| # | Asaxi word | Morae | Dictionary / phrase accent | Predicted in utterance | Class | Morpheme analysis |
|---:|---|---|---|---|---|---|
| 1 | gafůhùwaśbi | ga · fů · hù · wa · śbi | `H.L.L.L.L` | `H.L.L.L.L` | `lexical` | — |
| 2 | pỏpỏ | pỏ · pỏ | `H.L` | `H.L` | `lexical` | — |
...
<span class="asaxi-text">„wo ma!”</span>

Predicted sentence reading: `L.H↗`

Boundary tone: `LH%` (appeal contour with a final rise)

Speech act: `directive` · Source line: 170
...
Speech act: `statement` · Source line: 170
...
<span class="asaxi-text">„wo hùwaśbiwa ma!”</span>

Predicted sentence reading: `L.H.L.L.L.H↗`
...
Speech act: `directive` · Source line: 172
...
<span class="asaxi-text">tte onă ispăný pỏpỏ zëjù.</span>

Predicted sentence reading: `L.H.L.L.H.L.L.H.L.H.L`

Boundary tone: `L%` (closed assertion with a final fall)

Speech act: `statement` · Source line: 172
...
Speech act: `statement` · Source line: 174
...
Speech act: `directive` · Source line: 174
...
Speech act: `statement` · Source line: 176
...
| 3 | ă | ă | `H` | `H` | `dominant` | — |
| 4 | xő | xő | `L` | `L` | `atonal` | — |
| 5 | ŕăaxaśù | ŕă · a · xa · śù | `H.L.L.L` | `H.L.L.L` | `lexical` | — |
...
| 16 | ă | ă | `H` | `H` | `dominant` | — |
| 17 | xő | xő | `L` | `L` | `atonal` | — |
| 18 | ksá | ksá | `H` | `H` | `dominant` | — |
| 19 | o | o | `H` | `H` | `lexical` | — |
| 20 | pỏpa | pỏ · pa | `H.L` | `H.L` | `morphological` | `pỏpỏ` (root) + `-a` (plural) |
| 21 | chåxa | chå · xa | `H.L` | `H.L` | `lexical` | — |
| 22 | ken | ken | `L` | `L` | `atonal` | — |
| 23 | då | då | `L` | `L` | `atonal` | — |
| 24 | izo | i · zo | `L.L` | `L.L` | `atonal` | — |
| 25 | wao | wa · o | `L.H` | `L.H` | `lexical` | — |
| 26 | nono | no · no | `H.L` | `H.L` | `lexical` | — |
...
Speech act: `statement` · Source line: 178
...
| 17 | sè | sè | `L` | `L` | `atonal` | — |
| 18 | xő | xő | `L` | `L` | `atonal` | — |
| 19 | fù | fù | `H` | `H` | `lexical` | — |
| 20 | săbam | să · bam | `H.H` | `H.H` | `morphological` | `să` (root) + `-bam` (suffix) |
| 21 | zèŕoka | zè · ŕo · ka | `L.H.L` | `L.H.L` | `morphological` | `zè-` (prefix) + `ŕoka` (root) |
| 22 | sè | sè | `L` | `L` | `atonal` | — |
| 23 | xő | xő | `L` | `L` | `atonal` | — |
...
<span class="asaxi-text">„xő ăviŋůná!”</span>

Predicted sentence reading: `L.H.L.L.H↗`

Boundary tone: `LH%` (appeal contour with a final rise)

Speech act: `directive` · Source line: 180
...
Speech act: `statement` · Source line: 180
...
<span class="asaxi-text">„xő pỏpỏ săsă nèŕa!”</span>

Predicted sentence reading: `L.H.L.L.L.L.L↗`
...
| 2 | pỏpỏ | pỏ · pỏ | `H.L` | `H.L` | `lexical` | — |
| 3 | săsă | să · să | `L.L` | `L.L` | `atonal` | — |
| 4 | nèŕa | nè · ŕa | `L.L` | `L.L` | `atonal` | — |

### Utterance 134

<span class="asaxi-text">„xő xăcènă nèŕa!”</span>
...
|---:|---|---|---|---|---|---|
| 1 | xő | xő | `L` | `L` | `atonal` | — |
| 2 | xăcènă | xă · cè · nă | `H.L.L` | `H.L.L` | `lexical` | — |
| 3 | nèŕa | nè · ŕa | `L.L` | `L.L` | `atonal` | — |

### Utterance 135

<span class="asaxi-text">„wo xăcèshá xiŕa!”</span>

Predicted sentence reading: `L.H.L.L.L.L↗`

Boundary tone: `LH%` (appeal contour with a final rise)

Speech act: `directive` · Source line: 182
...
<span class="asaxi-text">tte onă hjinýj pỏpỏ zëjù, „wo xăcèshá xiŕa!”</span>

Predicted sentence reading: `L.L.L.L.H.H.H.L.H.L.L.H.L.L.L.L↗`
...
<span class="asaxi-text">„onă bỏhjá no zëjù!”</span>

Predicted sentence reading: `L.L.H.L.L.H.L↗`
...
Speech act: `statement` · Source line: 182
...
Speech act: `statement` · Source line: 184
...
<span class="asaxi-text">„naxogăhè ŕa zá wo igùŕanůè!”</span>

Predicted sentence reading: `L.L.H.L.L.L.L.H.L.L.L.L↗`

Boundary tone: `LH%` (appeal contour with a final rise)

Speech act: `directive` · Source line: 186

| # | Asaxi word | Morae | Dictionary / phrase accent | Predicted in utterance | Class | Morpheme analysis |
|---:|---|---|---|---|---|---|
| 1 | naxogăhè | na · xo · gă · hè | `L.L.H.L` | `L.L.H.L` | `morphological` | `na-` (prefix) + `xogă` (root) + `-hè` (suffix) |
| 2 | ŕa | ŕa | `L` | `L` | `atonal` | — |
| 3 | zá | zá | `L` | `L` | `atonal` | — |
| 4 | wo | wo | `L` | `L` | `atonal` | — |
...
Speech act: `statement` · Source line: 186
...
<span class="asaxi-text">„ox, naxogăhè!”</span>
...
|---:|---|---|---|---|---|---|
| 1 | ox | ox | `L` | `L` | `atonal` | — |
| 2 | naxogăhè | na · xo · gă · hè | `L.L.H.L` | `L.L.H.L` | `morphological` | `na-` (prefix) + `xogă` (root) + `-hè` (suffix) |

### Utterance 143

<span class="asaxi-text">„wo xăcèshá xiŕa tte wo xăcè!”</span>

Predicted sentence reading: `L.H.L.L.L.L.L.L.L.H.H↗`
...
Speech act: `statement` · Source line: 188
...
| 6 | să | să | `H` | `H` | `lexical` | — |
| 7 | ni | ni | `L` | `L` | `atonal` | — |
| 8 | izo | i · zo | `L.L` | `L.L` | `atonal` | — |
| 9 | zèhaśù | zè · ha · śù | `L.L.H` | `L.L.H` | `morphological` | `zè-` (prefix) + `haśù` (root) |
| 10 | ŕa | ŕa | `L` | `L` | `atonal` | — |
| 11 | txepỏvă | txe · pỏ · vă | `H.L.L` | `H.L.L` | `lexical` | — |
...
<span class="asaxi-text">„ox, aŕa!”</span>

Predicted sentence reading: `L.L.L↗`

Boundary tone: `LH%` (appeal contour with a final rise)

Speech act: `directive` · Source line: 190

| # | Asaxi word | Morae | Dictionary / phrase accent | Predicted in utterance | Class | Morpheme analysis |
|---:|---|---|---|---|---|---|
| 1 | ox | ox | `L` | `L` | `atonal` | — |
| 2 | aŕa | a · ŕa | `L.L` | `L.L` | `atonal` | — |

### Utterance 147

<span class="asaxi-text">tte xő zèŕima.</span>

Predicted sentence reading: `L.H.L.L.H.L`

Boundary tone: `L%` (closed assertion with a final fall)

Speech act: `statement` · Source line: 190

| # | Asaxi word | Morae | Dictionary / phrase accent | Predicted in utterance | Class | Morpheme analysis |
|---:|---|---|---|---|---|---|
| 1 | tte | t · te | `L.L` | `L.H` | `atonal` | — |
| 2 | xő | xő | `L` | `L` | `atonal` | — |
| 3 | zèŕima | zè · ŕi · ma | `L.H.L` | `L.H.L` | `morphological` | `zè-` (prefix) + `ŕima` (root) |

### Utterance 148

<span class="asaxi-text">„gja ksè no zèchåhaśù?”</span>

Predicted sentence reading: `L.H.L.L.L.L.L↗`

Boundary tone: `LH%` (appeal contour with a final rise)

Speech act: `question` · Source line: 190
...
<span class="asaxi-text">„gja ksè chěto' ŕa zá wo jýnů ken.ná zèbů?”</span>
...
| 1 | gja | gja | `L` | `L` | `atonal` | — |
| 2 | ksè | ksè | `H` | `H` | `dominant` | — |
| 3 | chěto' | chě · to' | `H.L` | `L.L` | `lexical` | — |
| 4 | ŕa | ŕa | `L` | `L` | `atonal` | — |
| 5 | zá | zá | `L` | `L` | `atonal` | — |
| 6 | wo | wo | `L` | `L` | `atonal` | — |
...
Speech act: `statement` · Source line: 192
...
| 14 | ŕa | ŕa | `L` | `L` | `atonal` | — |
| 15 | onă | o · nă | `L.L` | `L.L` | `atonal` | — |
| 16 | bỏhjá | bỏ · hjá | `H.L` | `H.L` | `lexical` | — |
| 17 | zèxogă | zè · xo · gă | `L.L.H` | `L.L.H` | `morphological` | `zè-` (prefix) + `xogă` (root) |
| 18 | ŕa | ŕa | `L` | `L` | `atonal` | — |
| 19 | xő | xő | `L` | `L` | `atonal` | — |
| 20 | ni | ni | `L` | `L` | `atonal` | — |
| 21 | waokam | wa · o · kam | `L.H.L` | `L.H.L` | `lexical` | — |
...
Speech act: `statement` · Source line: 197
...
| 8 | sè | sè | `L` | `L` | `atonal` | — |
| 9 | xő | xő | `L` | `L` | `atonal` | — |
| 10 | fùbiwa | fù · bi · wa | `H.L.L` | `H.L.L` | `morphological` | `fùbi` (root) + `-wa` (plural) |
...
Speech act: `statement` · Source line: 199
...
Speech act: `statement` · Source line: 204
...
Speech act: `statement` · Source line: 206
...
| 21 | kma | kma | `H` | `H` | `lexical` | — |
| 22 | vå | vå | `L` | `L` | `atonal` | — |
| 23 | jo | jo | `H` | `H` | `lexical` | — |
| 24 | pỏpỏ | pỏ · pỏ | `H.L` | `H.L` | `lexical` | — |
...
Speech act: `statement` · Source line: 208
...
| 36 | xő | xő | `L` | `L` | `atonal` | — |
| 37 | zèzhåka | zè · zhå · ka | `L.H.L` | `L.H.L` | `morphological` | `zè-` (prefix) + `zhåka` (root) |
| 38 | ŕa | ŕa | `L` | `L` | `atonal` | — |
| 39 | onă | o · nă | `L.L` | `L.L` | `atonal` | — |
| 40 | bỏhjá | bỏ · hjá | `H.L` | `H.L` | `lexical` | — |
| 41 | wo | wo | `L` | `L` | `atonal` | — |
| 42 | wëè | wë · è | `H.L` | `H.L` | `lexical` | — |
| 43 | tte | t · te | `L.L` | `L.L` | `atonal` | — |
| 44 | xő | xő | `L` | `L` | `atonal` | — |
...
Speech act: `statement` · Source line: 210
...
Speech act: `statement` · Source line: 212
...
Speech act: `statement` · Source line: 214
...
| 16 | obi | o · bi | `L.H` | `L.H` | `lexical` | — |
| 17 | zèŋawa | zè · ŋa · wa | `L.H.L` | `L.H.L` | `morphological` | `zè-` (prefix) + `ŋawa` (root) |
| 18 | ŕa | ŕa | `L` | `L` | `atonal` | — |
| 19 | hja | hja | `L` | `L` | `atonal` | — |
| 20 | ni | ni | `L` | `L` | `atonal` | — |
| 21 | sè | sè | `L` | `L` | `atonal` | — |
| 22 | xő | xő | `L` | `L` | `atonal` | — |
...
Speech act: `statement` · Source line: 216
...
Speech act: `statement` · Source line: 221
...
| 7 | ni | ni | `L` | `L` | `atonal` | — |
| 8 | xaembi | xa · e · mbi | `H.L.L` | `H.L.L` | `lexical` | — |
| 9 | hùzèmaaśù | hù · zè · ma · a · śù | `L.L.H.L.L` | `L.L.H.L.L` | `morphological` | `hù-` (prefix) + `zè-` (prefix) + `maaśù` (root) |
| 10 | ŕa | ŕa | `L` | `L` | `atonal` | — |
| 11 | onă | o · nă | `L.L` | `L.L` | `atonal` | — |
| 12 | hjinýj | hji · nýj | `H.H` | `H.H` | `mixed` | — |
| 13 | pỏpỏ | pỏ · pỏ | `H.L` | `H.L` | `lexical` | — |
...
<span class="asaxi-text">pwo onă bỏhjá ni ksùŕo hùpaxo.</span>

Predicted sentence reading: `H.L.L.H.L.L.L.H.L.L.L`

Boundary tone: `L%` (closed assertion with a final fall)

Speech act: `statement` · Source line: 223

| # | Asaxi word | Morae | Dictionary / phrase accent | Predicted in utterance | Class | Morpheme analysis |
|---:|---|---|---|---|---|---|
| 1 | pwo | pwo | `H` | `H` | `lexical` | — |
| 2 | onă | o · nă | `L.L` | `L.L` | `atonal` | — |
| 3 | bỏhjá | bỏ · hjá | `H.L` | `H.L` | `lexical` | — |
| 4 | ni | ni | `L` | `L` | `atonal` | — |
| 5 | ksùŕo | ksù · ŕo | `L.H` | `L.H` | `lexical` | — |
| 6 | hùpaxo | hù · pa · xo | `L.L.H` | `L.L.L` | `morphological` | `hù-` (prefix) + `pa-` (prefix) + `xo` (root) |

### Utterance 169

<span class="asaxi-text">nona săsă hùzèŕimpù, ŕa nå sè onă dokùshá xùjana xů să zèxiŕa.</span>

Predicted sentence reading: `H.L.L.L.L.L.H.L.L.L.L.L.L.L.L.H.H.L.L.H.H.L.H.H`
...
| # | Asaxi word | Morae | Dictionary / phrase accent | Predicted in utterance | Class | Morpheme analysis |
|---:|---|---|---|---|---|---|
| 1 | nona | no · na | `H.L` | `H.L` | `morphological` | `nono` (root) + `-a` (plural) |
| 2 | săsă | să · să | `L.L` | `L.L` | `atonal` | — |
| 3 | hùzèŕimpù | hù · zè · ŕi · mpù | `L.L.H.L` | `L.L.H.L` | `morphological` | `hù-` (prefix) + `zè-` (prefix) + `ŕimpù` (root) |
| 4 | ŕa | ŕa | `L` | `L` | `atonal` | — |
| 5 | nå | nå | `L` | `L` | `atonal` | — |
| 6 | sè | sè | `L` | `L` | `atonal` | — |
| 7 | onă | o · nă | `L.L` | `L.L` | `atonal` | — |
| 8 | dokùshá | do · kù · shá | `L.L.H` | `L.L.H` | `lexical` | — |
...
| 16 | să | să | `H` | `H` | `lexical` | — |
| 17 | pădåmë | pă · då · më | `L.H.L` | `L.H.L` | `morphological` | `pă-` (prefix) + `dåmë` (root) |
| 18 | ŕa | ŕa | `L` | `L` | `atonal` | — |
| 19 | zètaŕa | zè · ta · ŕa | `L.H.L` | `L.H.L` | `morphological` | `zè-` (prefix) + `taŕa` (root) |
...
<span class="asaxi-text">„wå!”</span>

Predicted sentence reading: `L↗`

Boundary tone: `LH%` (appeal contour with a final rise)

Speech act: `directive` · Source line: 225
...
<span class="asaxi-text">tte onă hjinýj pỏpỏ zèŕima.</span>

Predicted sentence reading: `L.H.L.L.H.H.H.L.L.H.L`

Boundary tone: `L%` (closed assertion with a final fall)

Speech act: `statement` · Source line: 225
...
| 3 | hjinýj | hji · nýj | `H.H` | `H.H` | `mixed` | — |
| 4 | pỏpỏ | pỏ · pỏ | `H.L` | `H.L` | `lexical` | — |
| 5 | zèŕima | zè · ŕi · ma | `L.H.L` | `L.H.L` | `morphological` | `zè-` (prefix) + `ŕima` (root) |

### Utterance 174

<span class="asaxi-text">„pwo wa ni ksùŕo paxo!”</span>

Predicted sentence reading: `H.L.L.L.H.L.H↗`
...
| 2 | wa | wa | `L` | `L` | `atonal` | — |
| 3 | ni | ni | `L` | `L` | `atonal` | — |
| 4 | ksùŕo | ksù · ŕo | `L.H` | `L.H` | `lexical` | — |
| 5 | paxo | pa · xo | `L.H` | `L.H` | `morphological` | `pa-` (prefix) + `xo` (root) |
...
Speech act: `statement` · Source line: 227
...
<span class="asaxi-text">„dhè sè xő txănýj pỏpỏhjá?”</span>

Predicted sentence reading: `L.L.L.L.L.L.L.L↗`

Boundary tone: `LH%` (appeal contour with a final rise)

Speech act: `question` · Source line: 229
...
<span class="asaxi-text">tte ko zèkëjù.</span>

Predicted sentence reading: `L.H.L.L.H.L`

Boundary tone: `L%` (closed assertion with a final fall)

Speech act: `statement` · Source line: 229
...
<span class="asaxi-text">„nonă?”</span>

Predicted sentence reading: `L.L↗`

Boundary tone: `LH%` (appeal contour with a final rise)

Speech act: `question` · Source line: 231
...
<span class="asaxi-text">tte onă dokùshá zëjù.</span>

Predicted sentence reading: `L.H.L.L.L.L.H.H.L`

Boundary tone: `L%` (closed assertion with a final fall)

Speech act: `statement` · Source line: 231
...
<span class="asaxi-text">„jo sè gapo-săaai jamikùkiwa maka xiŕa!”</span>

Predicted sentence reading: `H.L.H.L.H.L.L.L.H.L.L.L.L.H.H.L.L↗`

Boundary tone: `LH%` (appeal contour with a final rise)

Speech act: `directive` · Source line: 231
...
<span class="asaxi-text">„kjo?”</span>
...
| # | Asaxi word | Morae | Dictionary / phrase accent | Predicted in utterance | Class | Morpheme analysis |
|---:|---|---|---|---|---|---|
| 1 | kjo | kjo | `H` | `H` | `dominant` | — |

### Utterance 184

<span class="asaxi-text">„fůăvi!”</span>
...
| # | Asaxi word | Morae | Dictionary / phrase accent | Predicted in utterance | Class | Morpheme analysis |
|---:|---|---|---|---|---|---|
| 1 | fůăvi | fů · ă · vi | `H.L.L` | `H.L.L` | `lexical` | — |
...
Speech act: `statement` · Source line: 233
...
| 11 | dăgo | dă · go | `L.L` | `L.L` | `atonal` | — |
| 12 | ni | ni | `L` | `L` | `atonal` | — |
| 13 | pỏmáka | pỏ · má · ka | `H.L.L` | `H.L.L` | `lexical` | — |
| 14 | zètopù | zè · to · pù | `L.H.L` | `L.H.L` | `morphological` | `zè-` (prefix) + `topù` (root) |
| 15 | ŕa | ŕa | `L` | `L` | `atonal` | — |
| 16 | ni | ni | `L` | `L` | `atonal` | — |
| 17 | sè | sè | `L` | `L` | `atonal` | — |
| 18 | văŕo | vă · ŕo | `H.L` | `H.L` | `lexical` | — |
| 19 | tamo | ta · mo | `H.L` | `H.L` | `lexical` | — |
| 20 | hù | hù | `L` | `L` | `atonal` | — |
...
|---:|---|---|---|---|---|---|
| 1 | xő | xő | `L` | `H` | `atonal` | — |
| 2 | kaŕtèwa | ka · ŕtè · wa | `H.L.L` | `L.L.L` | `morphological` | `kaŕtè` (root) + `-wa` (plural) |
| 3 | ckanů | cka · nů | `H.H` | `H.H` | `mixed` | — |
| 4 | ŕa | ŕa | `L` | `L` | `atonal` | — |
...
| 16 | săsă | să · să | `L.L` | `L.L` | `atonal` | — |
| 17 | ŕăků | ŕă · ků | `H.L` | `H.L` | `lexical` | — |
| 18 | tte | t · te | `L.L` | `L.L` | `atonal` | — |
| 19 | xő | xő | `L` | `L` | `atonal` | — |
...
Speech act: `statement` · Source line: 238
...
Speech act: `statement` · Source line: 240
...
Speech act: `statement` · Source line: 242

| # | Asaxi word | Morae | Dictionary / phrase accent | Predicted in utterance | Class | Morpheme analysis |
|---:|---|---|---|---|---|---|
| 1 | xő | xő | `L` | `H` | `atonal` | — |
| 2 | hjinýj | hji · nýj | `H.H` | `L.H` | `mixed` | — |
| 3 | zèvexe | zè · ve · xe | `L.H.L` | `L.H.L` | `morphological` | `zè-` (prefix) + `vexe` (root) |
| 4 | sèwo | sè · wo | `L.L` | `L.L` | `atonal` | — |
| 5 | xő | xő | `L` | `L` | `atonal` | — |
...
Speech act: `statement` · Source line: 244

| # | Asaxi word | Morae | Dictionary / phrase accent | Predicted in utterance | Class | Morpheme analysis |
|---:|---|---|---|---|---|---|
| 1 | obi | o · bi | `L.H` | `H.L` | `lexical` | — |
| 2 | xő | xő | `L` | `L` | `atonal` | — |
| 3 | onă | o · nă | `L.L` | `L.L` | `atonal` | — |
| 4 | kŕahjákae | kŕa · hjá · ka · e | `H.L.L.L` | `H.L.L.L` | `lexical` | — |
...
Speech act: `directive` · Source line: 244
...
<span class="asaxi-text">— ŕa dănă ai ni xő zèxogă.</span>

Predicted sentence reading: `H.L.L.H.L.L.L.L.L.L`
...
| 3 | ai | a · i | `H.L` | `H.L` | `lexical` | — |
| 4 | ni | ni | `L` | `L` | `atonal` | — |
| 5 | xő | xő | `L` | `L` | `atonal` | — |
| 6 | zèxogă | zè · xo · gă | `L.L.H` | `L.L.L` | `morphological` | `zè-` (prefix) + `xogă` (root) |
...
Speech act: `statement` · Source line: 246
...
| 35 | vå | vå | `L` | `L` | `atonal` | — |
| 36 | xő | xő | `L` | `L` | `atonal` | — |
| 37 | bisă | bi · să | `L.H` | `L.H` | `morphological` | `bi-` (prefix) + `să` (root) |
| 38 | wo | wo | `L` | `L` | `atonal` | — |
| 39 | xăcèshá | xă · cè · shá | `H.L.L` | `H.L.L` | `lexical` | — |
| 40 | xiŕa | xi · ŕa | `L.L` | `L.L` | `atonal` | — |
| 41 | tte | t · te | `L.L` | `L.L` | `atonal` | — |
| 42 | zècè | zè · cè | `L.H` | `L.L` | `morphological` | `zè-` (prefix) + `cè` (root) |
...
Speech act: `statement` · Source line: 248
...
Speech act: `question` · Source line: 248

| # | Asaxi word | Morae | Dictionary / phrase accent | Predicted in utterance | Class | Morpheme analysis |
|---:|---|---|---|---|---|---|
| 1 | dhè | dhè | `L` | `L` | `atonal` | — |
| 2 | sùkixů | sù · ki · xů | `H.L.L` | `H.L.L` | `lexical` | — |
| 3 | jovi | jo · vi | `H.L` | `H.L` | `lexical` | — |
...
Speech act: `statement` · Source line: 250
...
Speech act: `statement` · Source line: 255
...
|---:|---|---|---|---|---|---|
| 1 | sèwo | sè · wo | `L.L` | `H.L` | `atonal` | — |
| 2 | ksi | ksi | `L` | `L` | `atonal` | — |
| 3 | onă | o · nă | `L.L` | `L.L` | `atonal` | — |
| 4 | mëŕo | më · ŕo | `H.L` | `H.L` | `lexical` | — |
| 5 | zèdopù | zè · do · pù | `L.H.L` | `L.H.L` | `morphological` | `zè-` (prefix) + `dopù` (root) |
| 6 | piva | pi · va | `H.L` | `H.L` | `lexical` | — |
...
| 11 | ksá | ksá | `H` | `H` | `dominant` | — |
| 12 | gaxiro | ga · xi · ro | `L.H.L` | `L.H.L` | `lexical` | — |
| 13 | ŕomaka | ŕo · ma · ka | `L.H.L` | `L.H.L` | `lexical` | — |
...
Speech act: `statement` · Source line: 257
...
Speech act: `statement` · Source line: 259
...
| 1 | sè | sè | `L` | `H` | `atonal` | — |
| 2 | ko | ko | `L` | `L` | `atonal` | — |
| 3 | kampỏno | ka · mpỏ · no | `L.H.L` | `L.H.L` | `lexical` | — |
...
<span class="asaxi-text">ŕa ko ni onă hjinýj pỏpỏ obi zèxogă, xő ni sè ko tëbiwa zèxapo, ŕa sè xő bă exù săsă ŕoŕonýj aksami fù zèmùa.</span>

Predicted sentence reading: `H.L.L.L.L.H.H.H.L.L.H.L.L.H.L.L.L.L.H.L.L.L.H.L.L.L.L.L.H.L.L.L.H.L.L.H.L.L.H.L.H.L`

Boundary tone: `L%` (closed assertion with a final fall)

Speech act: `statement` · Source line: 261
...
| 6 | pỏpỏ | pỏ · pỏ | `H.L` | `H.L` | `lexical` | — |
| 7 | obi | o · bi | `L.H` | `L.H` | `lexical` | — |
| 8 | zèxogă | zè · xo · gă | `L.L.H` | `L.L.H` | `morphological` | `zè-` (prefix) + `xogă` (root) |
| 9 | xő | xő | `L` | `L` | `atonal` | — |
| 10 | ni | ni | `L` | `L` | `atonal` | — |
| 11 | sè | sè | `L` | `L` | `atonal` | — |
| 12 | ko | ko | `L` | `L` | `atonal` | — |
| 13 | tëbiwa | të · bi · wa | `H.L.L` | `H.L.L` | `morphological` | `tëbi` (root) + `-wa` (plural) |
| 14 | zèxapo | zè · xa · po | `L.H.L` | `L.H.L` | `morphological` | `zè-` (prefix) + `xapo` (root) |
| 15 | ŕa | ŕa | `L` | `L` | `atonal` | — |
| 16 | sè | sè | `L` | `L` | `atonal` | — |
| 17 | xő | xő | `L` | `L` | `atonal` | — |
| 18 | bă | bă | `L` | `L` | `atonal` | — |
...
<span class="asaxi-text">„ăjo hjinýj pỏpỏ,” tte ko zëjù, „wo kshá xiŕa tte no cèná kè?”</span>

Predicted sentence reading: `H.L.L.L.L.L.L.L.L.H.L.L.H.L.L.L.L.L.H.H.L↗`

Boundary tone: `LH%` (appeal contour with a final rise)

Speech act: `question` · Source line: 263

| # | Asaxi word | Morae | Dictionary / phrase accent | Predicted in utterance | Class | Morpheme analysis |
|---:|---|---|---|---|---|---|
| 1 | ăjo | ă · jo | `H.L` | `H.L` | `lexical` | — |
| 2 | hjinýj | hji · nýj | `H.H` | `L.L` | `mixed` | — |
...
Speech act: `statement` · Source line: 265
...
<span class="asaxi-text">„wo sè hjávakam-txaŕăijo txenshá xiŕa,” tte ko zëjù.</span>

Predicted sentence reading: `H.L.H.L.L.H.L.L.L.H.L.L.L.L.L.L.H.L`

Boundary tone: `L%` (closed assertion with a final fall)

Speech act: `statement` · Source line: 267
...
| 2 | sè | sè | `L` | `L` | `atonal` | — |
| 3 | hjávakam | hjá · va · kam | `H.L.L` | `H.L.L` | `lexical` | — |
| 4 | txaŕăijo | txa · ŕă · i · jo | `H.L.L.L` | `H.L.L.L` | `lexical` | — |
| 5 | txenshá | txe · nshá | `H.L` | `H.L` | `lexical` | — |
| 6 | xiŕa | xi · ŕa | `L.L` | `L.L` | `atonal` | — |
| 7 | tte | t · te | `L.L` | `L.L` | `atonal` | — |
| 8 | ko | ko | `L` | `L` | `atonal` | — |
| 9 | zëjù | zë · jù | `H.L` | `H.L` | `morphological` | `zè-` (prefix) + `ijù` (lexical unit) |
...
<span class="asaxi-text">„wo onă hjáma hùzèsùkixů igùŕana săsă sùva.”</span>

Predicted sentence reading: `H.L.L.H.H.L.L.H.L.L.H.L.L.L.L.L.H.L`
...
<span class="asaxi-text">„hùwo wo xăcèshá zènèŕa kè?”</span>

Predicted sentence reading: `L.H.L.H.L.L.H.L.L.L↗`

Boundary tone: `LH%` (appeal contour with a final rise)

Speech act: `question` · Source line: 269

| # | Asaxi word | Morae | Dictionary / phrase accent | Predicted in utterance | Class | Morpheme analysis |
|---:|---|---|---|---|---|---|
| 1 | hùwo | hù · wo | `L.H` | `L.H` | `lexical` | — |
| 2 | wo | wo | `L` | `L` | `atonal` | — |
| 3 | xăcèshá | xă · cè · shá | `H.L.L` | `H.L.L` | `lexical` | — |
| 4 | zènèŕa | zè · nè · ŕa | `H.L.L` | `H.L.L` | `lexical` | — |
| 5 | kè | kè | `L` | `L` | `atonal` | — |
...
<span class="asaxi-text">tte onă hjinýj pỏpỏ zèkëjù.</span>

Predicted sentence reading: `L.H.L.L.H.H.H.L.L.H.L`

Boundary tone: `L%` (closed assertion with a final fall)

Speech act: `statement` · Source line: 269
...
<span class="asaxi-text">„då onă bỏhjá no xăcèshá zèxiŕa,” tte onă txenshá zëjù, „sèwo xő ni no zèsùkixů.”</span>

Predicted sentence reading: `H.L.L.H.L.L.H.L.L.L.H.H.L.L.L.L.H.L.H.L.L.L.L.L.L.L.H.L.L`

Boundary tone: `L%` (closed assertion with a final fall)

Speech act: `statement` · Source line: 271
...
Speech act: `statement` · Source line: 273
...
| 10 | obi | o · bi | `L.H` | `L.H` | `lexical` | — |
| 11 | zèkma | zè · kma | `L.H` | `L.H` | `morphological` | `zè-` (prefix) + `kma` (root) |
| 12 | ŕa | ŕa | `L` | `L` | `atonal` | — |
| 13 | zá | zá | `L` | `L` | `atonal` | — |
| 14 | xő | xő | `L` | `L` | `atonal` | — |
| 15 | ni | ni | `L` | `L` | `atonal` | — |
...
Speech act: `statement` · Source line: 278
...
| 18 | gja | gja | `L` | `L` | `atonal` | — |
| 19 | onă | o · nă | `L.L` | `L.L` | `atonal` | — |
| 20 | txenshá | txe · nshá | `H.L` | `H.L` | `lexical` | — |
| 21 | ijo | i · jo | `H.L` | `H.L` | `lexical` | — |
| 22 | vå | vå | `L` | `L` | `atonal` | — |
...
Speech act: `statement` · Source line: 280
...
Speech act: `directive` · Source line: 280
...
| 16 | cèdaohè | cè · da · o · hè | `H.L.L.L` | `H.L.L.L` | `morphological` | `cèdao` (root) + `-hè` (suffix) |
| 17 | sèwo | sè · wo | `L.L` | `L.L` | `atonal` | — |
| 18 | xő | xő | `L` | `L` | `atonal` | — |
| 19 | zá | zá | `L` | `L` | `atonal` | — |
| 20 | na | na | `L` | `L` | `atonal` | — |
...
<span class="asaxi-text">ŕa ko onă hjinýj pỏpỏ nazèmùa ŕa xő na vivi zèpùto.</span>

Predicted sentence reading: `H.L.L.L.H.H.H.L.L.L.H.L.L.L.L.H.L.L.H.L`

Boundary tone: `L%` (closed assertion with a final fall)

Speech act: `statement` · Source line: 282
...
| 4 | hjinýj | hji · nýj | `H.H` | `H.H` | `mixed` | — |
| 5 | pỏpỏ | pỏ · pỏ | `H.L` | `H.L` | `lexical` | — |
| 6 | nazèmùa | na · zè · mù · a | `L.L.H.L` | `L.L.H.L` | `morphological` | `na-` (prefix) + `zè-` (prefix) + `mùa` (root) |
| 7 | ŕa | ŕa | `L` | `L` | `atonal` | — |
| 8 | xő | xő | `L` | `L` | `atonal` | — |
| 9 | na | na | `L` | `L` | `atonal` | — |
| 10 | vivi | vi · vi | `H.L` | `H.L` | `lexical` | — |
| 11 | zèpùto | zè · pù · to | `L.H.L` | `L.H.L` | `morphological` | `zè-` (prefix) + `pùto` (root) |

### Utterance 227

<span class="asaxi-text">„haśùhè ŕa igùŕanůè, ăjo hjinýj pỏpỏ!”</span>

Predicted sentence reading: `L.H.L.L.H.L.L.L.L.H.L.H.H.H.L↗`

Boundary tone: `LH%` (appeal contour with a final rise)

Speech act: `directive` · Source line: 284
...
Speech act: `statement` · Source line: 284
...
Speech act: `statement` · Source line: 286
...
| 19 | ŕa | ŕa | `L` | `L` | `atonal` | — |
| 20 | xő | xő | `L` | `L` | `atonal` | — |
| 21 | gja | gja | `L` | `L` | `atonal` | — |
| 22 | xő | xő | `L` | `L` | `atonal` | — |
| 23 | izo | i · zo | `L.L` | `L.L` | `atonal` | — |
| 24 | să | să | `H` | `H` | `lexical` | — |
| 25 | nono | no · no | `H.L` | `H.L` | `lexical` | — |
| 26 | săsă | să · să | `L.L` | `L.L` | `atonal` | — |
...
| 1 | xő | xő | `L` | `H` | `atonal` | — |
| 2 | onă | o · nă | `L.L` | `L.L` | `atonal` | — |
| 3 | txenshá | txe · nshá | `H.L` | `H.L` | `lexical` | — |
| 4 | xő | xő | `L` | `L` | `atonal` | — |
| 5 | nýjmåmåbam | ný · jmå · må · bam | `L.H.L.L` | `L.H.L.L` | `morphological` | `nýj-` (prefix) + `måmå` (root) + `-bam` (suffix) |
| 6 | mùa | mù · a | `H.L` | `H.L` | `lexical` | — |
| 7 | vå | vå | `L` | `L` | `atonal` | — |
| 8 | ko | ko | `L` | `L` | `atonal` | — |
| 9 | xő | xő | `L` | `L` | `atonal` | — |
| 10 | săsă | să · să | `L.L` | `L.L` | `atonal` | — |
...
Speech act: `statement` · Source line: 288
...
| 19 | ŕa | ŕa | `L` | `L` | `atonal` | — |
| 20 | wo | wo | `L` | `L` | `atonal` | — |
| 21 | kjo | kjo | `H` | `H` | `dominant` | — |
| 22 | xů | xů | `H` | `H` | `lexical` | — |
| 23 | ŕima | ŕi · ma | `H.L` | `H.L` | `lexical` | — |
| 24 | panå | pa · nå | `L.L` | `L.L` | `atonal` | — |
| 25 | xő | xő | `L` | `L` | `atonal` | — |
| 26 | sè | sè | `L` | `L` | `atonal` | — |
| 27 | xő | xő | `L` | `L` | `atonal` | — |
| 28 | hùhjixaśbi | hù · hji · xa · śbi | `L.H.H.H` | `L.H.H.H` | `morphological` | `hù-` (prefix) + `hjixaśbi` (root) |
| 29 | zèxapo | zè · xa · po | `L.H.L` | `L.H.L` | `morphological` | `zè-` (prefix) + `xapo` (root) |
| 30 | jo | jo | `H` | `H` | `lexical` | — |
| 31 | kŕasa | kŕa · sa | `H.L` | `H.L` | `lexical` | — |
| 32 | då | då | `L` | `L` | `atonal` | — |
...
<span class="asaxi-text">ŕa xő wo hùwaśbiwa xăma!</span>

Predicted sentence reading: `L.L.L.H.L.L.L.H.H↗`

Boundary tone: `LH%` (appeal contour with a final rise)

Speech act: `directive` · Source line: 290
...
<span class="asaxi-text">zècèxa.</span>

Predicted sentence reading: `H.L.L`

Boundary tone: `L%` (closed assertion with a final fall)

Speech act: `statement` · Source line: 290

| # | Asaxi word | Morae | Dictionary / phrase accent | Predicted in utterance | Class | Morpheme analysis |
|---:|---|---|---|---|---|---|
| 1 | zècèxa | zè · cè · xa | `L.H.L` | `H.L.L` | `morphological` | `zè-` (prefix) + `cèxa` (root) |
...
Speech act: `statement` · Source line: 292

| # | Asaxi word | Morae | Dictionary / phrase accent | Predicted in utterance | Class | Morpheme analysis |
|---:|---|---|---|---|---|---|
| 1 | xő | xő | `L` | `H` | `atonal` | — |
| 2 | săbam | să · bam | `H.H` | `L.H` | `morphological` | `să` (root) + `-bam` (suffix) |
| 3 | zèchåxa | zè · chå · xa | `L.H.L` | `L.H.L` | `morphological` | `zè-` (prefix) + `chåxa` (root) |
| 4 | ŕa | ŕa | `L` | `L` | `atonal` | — |
| 5 | sè | sè | `L` | `L` | `atonal` | — |
...
| 32 | onă | o · nă | `L.L` | `L.L` | `atonal` | — |
| 33 | txenshá | txe · nshá | `H.L` | `H.L` | `lexical` | — |
| 34 | ăxo | ă · xo | `H.L` | `H.L` | `lexical` | — |
| 35 | då | då | `L` | `L` | `atonal` | — |
...
Speech act: `statement` · Source line: 294
...
Speech act: `statement` · Source line: 299

| # | Asaxi word | Morae | Dictionary / phrase accent | Predicted in utterance | Class | Morpheme analysis |
|---:|---|---|---|---|---|---|
| 1 | vănotxă | vă · no · txă | `H.L.L` | `H.L.L` | `lexical` | — |
| 2 | ja | ja | `L` | `L` | `atonal` | — |
...
| 7 | izo | i · zo | `L.L` | `L.L` | `atonal` | — |
| 8 | txepỏvă | txe · pỏ · vă | `H.L.L` | `H.L.L` | `lexical` | — |
...
Speech act: `statement` · Source line: 301
...
| 25 | pădåmë | pă · då · më | `L.H.L` | `L.H.L` | `morphological` | `pă-` (prefix) + `dåmë` (root) |
...
Speech act: `statement` · Source line: 303
...
Speech act: `directive` · Source line: 305
...
Speech act: `statement` · Source line: 307
...
| 19 | då | då | `L` | `L` | `atonal` | — |
| 20 | hùzènaxogă | hù · zè · na · xo · gă | `L.L.L.L.H` | `L.L.L.L.L` | `morphological` | `hù-` (prefix) + `zè-` (prefix) + `na-` (prefix) + `xogă` (root) |
...
<span class="asaxi-text">— måmå.</span>

Predicted sentence reading: `H.L`

Boundary tone: `L%` (closed assertion with a final fall)

Speech act: `statement` · Source line: 309

| # | Asaxi word | Morae | Dictionary / phrase accent | Predicted in utterance | Class | Morpheme analysis |
|---:|---|---|---|---|---|---|
| 1 | måmå | må · må | `H.L` | `H.L` | `lexical` | — |
