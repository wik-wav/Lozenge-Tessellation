---
title: fůtăgo (Quantifier) - "Some", "A number of", "Several", "An unspecified amount (greater than zero)"
Word (Asaxi): fůtăgo
...
- **Meaning:** "Some", "A number of", "Several", "An unspecified amount (greater than zero)".
...
**[[fů (root word)|fů]]** (Lack/Unknown) + **[[tă (Mathematical Operator)|tă]]** (Plus/Positive) + **[[sigo (noun)|(si)go]]** (Number).
*Lit:* "Unknown-Positive-Number."

### Antonyms

- **[[dzeŕo (Number)|dzeŕo]]** (Zero / None).
- **[[sigo (noun)|sigo]]** (Number - specific).
