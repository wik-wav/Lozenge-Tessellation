---
title: 14_Future & Complex Tenses
tags:
  - Asaxi
  - language
  - grammar
...
- **Etymology:** Derived from **[[07_Describing Location in Asaxi|pa-]]** (Front/Anterior).
...
Used to express an action that _will be completed_ at a specific point in the future ("Will have done").
...
Used to express an action that happened _before_ another past action ("Had done").

- **Etymology:** Derived from **[[07_Describing Location in Asaxi|hù-]]** (Behind).
...
- **Etymology:** `ni` (Into) + `x` (Bridge) + **[[å (noun)|å]]** (Time).
