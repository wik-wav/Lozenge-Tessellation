---
title: ninå (THEREFORE Logical Clause Connector) - Therefore
Word (Asaxi): ninå
...
**[[sè (Relational Particle)|sè]]** (From/Source) + **[[o (Proximal Locative Prefix)|o]]** (Here). _Lit:_ "From this."
**[[ni (Relational Particle)|ni]]** - (Toward) + **[[nå (NOW Aspectual Marker)|nå]]** (now)
